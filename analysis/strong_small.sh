...
echo "Starting strong scaling analysis on small input"
...
export NAME_DESC=strong_smallIN
export WORK_DIR_BASE=$(pwd)/results/strong/small/
export QOS=debug
export INPUT_FILE=$(pwd)/indat/strong/indat_small
